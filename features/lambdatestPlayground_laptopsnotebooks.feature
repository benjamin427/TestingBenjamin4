Feature: Laptop page of the ecommerce playground.lambdatest.io website 
    ...
    Scenario: Select an item after choosing a category
        ...
        Then Select laptops and notebooks category from the slide menu
    ...
    Scenario: Select item from category and save in cart
        ...
        Then Select laptops and notebooks category from menu
