Feature: Printers and scanners page of the ecommerce playground.lambdatest.io website 
    ...
    Scenario: Select an item after choosing a category
        ...
        Then Select printers and scanners from the slide menu
    ...
    Scenario: Select item from category and save in cart
        ...
        Then Select printers and scanners from menu
